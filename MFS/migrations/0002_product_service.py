    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('cust_name', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='products', to='MFS.Customer')),
            ],
        ),
        migrations.CreateModel(
            name='Service',
            fields=[
                ...
                ('created_date', models.DateTimeField(default=django.utils.timezone.now)),
                ('updated_date', models.DateTimeField(auto_now_add=True)),
                ('cust_name', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='services', to='MFS.Customer')),
            ],
        ),
    ]
